...
nadelsumpfarr=convert_tif_to_array(myworkspace+"/beSW09.tif")#benadelwaeldersumpfflachmooromhmsaosaJURA.tif")
sw14arr=convert_tif_to_array(myworkspace+"/beSW14.tif")
...
#plt.imshow(outarr)
#write output
convertarrtotif(outarr, myworkspace+"/"+"besonderwald.tif", 1, referenceraster, NODATA_value)
print("done ...")
