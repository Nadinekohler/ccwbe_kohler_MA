...
outarr=np.where(((bachschuttarr==1)&(hoehenstufenarr==2)&(slopearr>=0)&(slopearr<=30)),1,outarr)
...
outarr=np.where(((bachschuttarr==1)&(hoehenstufenarr==2)&(slopearr>=0)&(slopearr<=30)&(regionenarr==2)&(rissmoraenearr!=1)),17,outarr)
...
outarr=np.where(((begrossflozschwemmgebietarr==1)&(slopearr>=0)&(slopearr<=10)&(hoehenstufenarr==2)),10,outarr)
...
outarr=np.where(((beflozbuffer1_6_30m_arr==1)&(hoehenstufenarr==2)&(slopearr<=20)),13,outarr)
...
outarr=np.where(((buffer20marr==1)&(hoehenstufenarr==2)&(auarr==1)),12,outarr)
