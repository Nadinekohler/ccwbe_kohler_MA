...
projectspace="C:/DATA/projects/CCWBE/GIS"
...
combinations_df=gpd.read_file(projectspace+"/Modellergebnisse/"+"stok_gdf_arrondiert_attributed_nais_"+climatescenario+".shp")
len(combinations_df)
combinations_df.columns
combinations_df=combinations_df[['nais', 'mo', 'ue', 'taheute', 'storeg','slpprzrec', 'radiation', 'hsmodcod', 'lage', 'tahs', 'ta','taue', 'tauehs', 'HS_de', 'Code', 'Subcode','geometry']]
combinations_df.columns
...
combinations_df=combinations_df.astype({'ta': 'str','tahs': 'str', 'taue':'str','tauehs':'str'})
...
combinations_df.loc[combinations_df["ta"]=="18W", "ta"] = "18w"
...
#listofnopathcombinations
nopathoutfile=open(projectspace+"/Modellergebnisse/"+climatescenario.lower()+"_listofnopathcombinations.txt", "w")
...
for item in listofnopathcombinations2:
    nopathoutfile.write(str(item[0])+";"+str(item[1])+";"+str(item[2])+";"+str(item[3])+"\n")
nopathoutfile.close()
joblib.dump(combinations_df, projectspace+"/Modellergebnisse/"+climatescenario+"_combinations_df_futureSTO.sav")
