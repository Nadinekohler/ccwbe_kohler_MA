...
#input data
codeworkspace=r"C:\DATA\projects\CCWBE\GitHub\ccwbe"
projectspace=r"E:\CCWBE\GIS"
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/"+"nais_matrix_standorte_list.sav")
...
for sto in standortstypen_projektionspfade_heute_list:
    if sto not in nais_matrix_standorte_list:
        projektionspfadestandortstyp_heute_notin_NAISmatrix.append(sto) #Standortstypen, die nicht in der Matrixtabelle vorkommen, werden nicht beruecksichtigt.
...
combinations_df=gpd.read_file(projectspace+"/"+"stok_gdf_attributed_nais_select_"+climatescenario+".shp")
len(combinations_df)
combinations_df.columns

#Berechne Nais ueberall
combinations_df["naiscombi"]=""
combinations_df.loc[combinations_df["regionid"]==1],"naiscombi"]=combinations_df["NaiS_LFI_J"]
combinations_df.loc[combinations_df["regionid"]==2],"naiscombi"]=combinations_df["NaiS_LFI_M"]
combinations_df.loc[combinations_df["regionid"]==3],"naiscombi"]=combinations_df["NaiS_LFI_M"]
...
stok_gdf["ta"]=""
stok_gdf["taue"]=""
stok_gdf["naismo"]=""#evtl alles in ue
naistypen=[]
for index, row in stok_gdf.iterrows():
    naistyp=row['naiscombi']
    if "/" in naistyp and "(" in naistyp:
        stok_gdf.loc[index, "mo"] = 1
        stok_gdf.loc[index, "ue"] = 1
        naistyp2 = naistyp.replace("/", " ")
        naistyp2 = naistyp2.replace(")", " ")
        naistyp2 = naistyp2.replace("(", " ")
        naistyp2 = naistyp2.replace("  ", " ")
        nais1 = naistyp2.strip().split()[0]
        naisuebergang = naistyp2.strip().split()[1]
        naismosaic = naistyp2.strip().split()[2]
        stok_gdf.loc[index, "ta"] = nais1
        stok_gdf.loc[index, "taue"] = naisuebergang
        stok_gdf.loc[index, "taue"] = naismosaic
        if nais1 not in naistypen:
            naistypen.append(nais1)
        if naisuebergang not in naistypen:
            naistypen.append(naisuebergang)
        if naismosaic not in naistypen:
            naistypen.append(naismosaic)
    elif "/" in naistyp and "(" not in naistyp:
        stok_gdf.loc[index,"mo"]=1
        naistyp2=naistyp.replace("/"," ")
        nais1=naistyp2.strip().split()[0]
        naismosaic = naistyp2.strip().split()[1]
        stok_gdf.loc[index, "ta"]=nais1
        stok_gdf.loc[index, "taue"] = naismosaic
        if nais1 not in naistypen:
            naistypen.append(nais1)
        ...
        stok_gdf.loc[index, "ta"] = naistyp
        if naistyp not in naistypen:
            naistypen.append(naistyp)




combinations_df=combinations_df[['BE', 'taheute', 'storeg', 'lage','slpprzrec','radiation', 'mo', 'ue', 'hsmod','hsmodcod', 'nais1', 'naisue', 'naismo','HS_de','Subcode','geometry']]
...
combinations_df.columns #hat Spalten reduziert auf die wichtigsten
combinations_df.rename(columns={"HS_de":"hs_de","Subcode":"subcode"}, inplace=True)
combinations_df.columns
#combinations_df.loc[combinations_df["tauehs"].isna(),"tauehs"]="_"
combinations_df["tauehs"]=combinations_df["hsmod"]
#combinations_df=combinations_df[combinations_df["ta"]!="_"]
len(combinations_df)
combinations_df=combinations_df.astype({'storeg': 'str','subcode': int})
combinations_df=combinations_df.astype({'mo': int,'ue': int})
combinations_df=combinations_df.astype({'tauehs':'str'})
combinations_df.dtypes
combinations_df.rename(columns = {'nais1':'ta','naisue':'taue', 'hsmod':'tahs'}, inplace = True)
#combinations_df=combinations_df.astype({'hsmod': 'str'})
#add columns
...
#Korrekturen
#check=combinations_df[combinations_df["taue"]=="9a(11)"]
#check=combinations_df[((combinations_df["taue"]=="46M(70)")&(combinations_df["DTWGEINHEI"]=="70L(46R)"))]
#"51/46" in combinations_df["taue"].unique().tolist()
#combinations_df.loc[combinations_df["ta"]=="9","ta"]="9a"
#combinations_df.loc[combinations_df["taue"]=="9","taue"]="9a"
#combinations_df.loc[combinations_df["ta"]=="11Fe","ta"]="11"
#combinations_df.loc[combinations_df["taue"]=="11Fe","taue"]="11"
#combinations_df.loc[combinations_df["ta"]=="12SFe","ta"]="12S"
#combinations_df.loc[combinations_df["taue"]=="12SFe","taue"]="12S"
#combinations_df.loc[combinations_df["ta"]=="12g","ta"]="12S"
#combinations_df.loc[combinations_df["taue"]=="12g","taue"]="12S"
#combinations_df.loc[combinations_df["ta"]=="8SFe","ta"]="8S"
#combinations_df.loc[combinations_df["taue"]=="8SFe","taue"]="8S"
#combinations_df.loc[combinations_df["ta"]=="18FeG","ta"]="18G"
#combinations_df.loc[combinations_df["taue"]=="18FeG","taue"]="18G"
#combinations_df.loc[combinations_df["ta"]=="60*TaG","ta"]="60*G"
#combinations_df.loc[combinations_df["taue"]=="60*TaG","taue"]="60*G"
#combinations_df.loc[combinations_df["ta"]=="12","ta"]="12a"
#combinations_df.loc[combinations_df["taue"]=="12","taue"]="12a"
#combinations_df.loc[combinations_df["taue"]=="51(46)","taue"]="51"
#combinations_df.loc[((combinations_df["taue"]=="46M(70)")&(combinations_df["DTWGEINHEI"]=="70L(46R)")),"ta"]="70G"
#combinations_df.loc[((combinations_df["taue"]=="46M(70)")&(combinations_df["DTWGEINHEI"]=="70L(46R)")),"taue"]="46M"
#combinations_df.loc[((combinations_df["taue"]=="46M(70)")&(combinations_df["DTWGEINHEI"]=="50*(46R)")),"ta"]="50*"
#combinations_df.loc[((combinations_df["taue"]=="46M(70)")&(combinations_df["DTWGEINHEI"]=="50*(46R)")),"taue"]="46M"
#combinations_df.loc[((combinations_df["taue"]=="50*(46R)")&(combinations_df["DTWGEINHEI"]=="70L(46R)")),"taue"]="46M"
#combinations_df.loc[((combinations_df["taue"]=="7a(9a)")&(combinations_df["DTWGEINHEI"]=="29(7f)")),"taue"]="7a"
#combinations_df.loc[((combinations_df["taue"]=="7a(9a)")&(combinations_df["DTWGEINHEI"]=="29C(7f)")),"taue"]="7a"
#combinations_df.loc[((combinations_df["taue"]=="8a(12a)")&(combinations_df["DTWGEINHEI"]=="29(8f)")),"ta"]="29A"
#combinations_df.loc[((combinations_df["taue"]=="8a(12a)")&(combinations_df["DTWGEINHEI"]=="29(8f)")),"taue"]="8a"
#combinations_df.loc[((combinations_df["taue"]=="8a(12a)")&(combinations_df["DTWGEINHEI"]=="29/8f")),"ta"]="29A"
#combinations_df.loc[((combinations_df["taue"]=="8a(12a)")&(combinations_df["DTWGEINHEI"]=="29/8f")),"taue"]="8a"
#combinations_df.loc[((combinations_df["taue"]=="7a(10a)")&(combinations_df["DTWGEINHEI"]=="29C(7e)")),"taue"]="7a"
#combinations_df.loc[((combinations_df["taue"]=="40T")&(combinations_df["DTWGEINHEI"]=="25C(40T)")),"taue"]="40*"
#combinations_df.loc[((combinations_df["taue"]=="9a(11)")&(combinations_df["DTWGEINHEI"]=="25C(9g)")),"taue"]="9a"
#combinations_df.loc[((combinations_df["taue"]=="9a(11)")&(combinations_df["DTWGEINHEI"]=="29(9g)")),"taue"]="9a"

#combinations_df.loc[(combinations_df['DTWGEINHEI']=='11(18M)'), 'DTWGEINHEI']='12g(18M))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='46(57)/60(56)'), 'DTWGEINHEI']='46(57S)/60(56))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='46(57)'), 'DTWGEINHEI']='46(57V))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='46*(57)'), 'DTWGEINHEI']='46*(57S))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='46*(57)'), 'DTWGEINHEI']='46*(57S))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='46*(57)/u'), 'DTWGEINHEI']='46*(57S/u)'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='49(57)'), 'DTWGEINHEI']='49(57S))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='49/46*/57'), 'DTWGEINHEI']='49/46*/57S)'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='51(57)'), 'DTWGEINHEI']='51(57V))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='53(57)'), 'DTWGEINHEI']='53(57V))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='53L(19*L)'), 'DTWGEINHEI']='53L(18*L))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='56(57)'), 'DTWGEINHEI']='56(57S))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='53Bl(72)/u'), 'DTWGEINHEI']='57Bl(72)/u)'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='57(60*)'), 'DTWGEINHEI']='57V(60*))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='57(70)'), 'DTWGEINHEI']='57V(70))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='60(57)/u'), 'DTWGEINHEI']='60(57V)/u)'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='69L(57)'), 'DTWGEINHEI']='69L(57C))'
#combinations_df.loc[(combinations_df['DTWGEINHEI']=='72(57)/u'), 'DTWGEINHEI']='72(57V)/u)'
#combinations_df.loc[combinations_df["ta"]=="25*Fe", "ta"] = "25*"
...
#combinations_df.loc[combinations_df["tahs"]=="co", "tahs"] = "collin"
#combinations_df.loc[combinations_df["tahs"]=="sm", "tahs"] = "submontan"
#combinations_df.loc[combinations_df["tahs"]=="um", "tahs"] = "untermontan"
#combinations_df.loc[combinations_df["tahs"]=="om", "tahs"] = "obermontan"
#combinations_df.loc[combinations_df["tahs"]=="hm", "tahs"] = "hochmontan"
#combinations_df.loc[combinations_df["tahs"]=="sa", "tahs"] = "subalpin"
#combinations_df.loc[combinations_df["tahs"]=="osa", "tahs"] = "obersubalpin"
#combinations_df.loc[combinations_df["tauehs"]=="co", "tauehs"] = "collin"
#combinations_df.loc[combinations_df["tauehs"]=="sm", "tauehs"] = "submontan"
#combinations_df.loc[combinations_df["tauehs"]=="um", "tauehs"] = "untermontan"
#combinations_df.loc[combinations_df["tauehs"]=="om", "tauehs"] = "obermontan"
#combinations_df.loc[combinations_df["tauehs"]=="hm", "tauehs"] = "hochmontan"
#combinations_df.loc[combinations_df["tauehs"]=="sa", "tauehs"] = "subalpin"
#combinations_df.loc[combinations_df["tauehs"]=="osa", "tauehs"] = "obersubalpin"
combinations_df.loc[combinations_df["tauehs"].isnull(), "tauehs"] = "_"
...
#falls viele Standortstypen nicht in den Projektionswegen vorkommen, muesste man es mit Barbara anschauen. Muesste man im Originalfile austauschen.
print("NAIS Typen 1 nicht in Projektionspfade: ")
for item in combinations_df['ta'].unique().tolist():
    if item not in standortstypen_projektionspfade_heute_list:
        print(item)
print("NAIS Typen 2 nicht in Projektionspfade: ")
for item in combinations_df['taue'].unique().tolist():
    if item not in standortstypen_projektionspfade_heute_list:
        print(item)
...
#check empty values, gibt es viele Polygone ohne Hoehenstufenzuordnung?
nohs1list=combinations_df[combinations_df["tahs"]==""]["ta"].unique().tolist()
len(nohs1list)
nohs2list=combinations_df[((combinations_df["tauehs"]=="")&(combinations_df["ue"]==1))]["taue"].unique().tolist()
len(nohs2list)
...
for index, row in combinations_df.iterrows():
    if [row["storegco"],row["ta"], row["tahs"]] not in region_foresttype_belt_inprojektionspfade:
        listpotentialbelts=[]
        for item in region_foresttype_belt_inprojektionspfade:
            if item[0]==row["storegco"] and item[1]==row["ta"]:
                listpotentialbelts.append(item[2])
        if len(listpotentialbelts)>0:
            combinations_df.loc[index, "tahs"] = listpotentialbelts[-1]
        else:
            if [row["storegco"], row["ta"],row["hs_de"]] in region_foresttype_belt_inprojektionspfade:
                combinations_df.loc[index, "tahs"] = row['hs_de']
    if row["taue"]!="" and [row["storegco"],row["ta"], row["tauehs"]] not in region_foresttype_belt_inprojektionspfade:
        listpotentialbelts=[]
        for item in region_foresttype_belt_inprojektionspfade:
            if item[0]==row["storegco"] and item[1]==row["taue"]:
                listpotentialbelts.append(item[2])
        if len(listpotentialbelts)>0:
            combinations_df.loc[index, "tauehs"] = listpotentialbelts[-1]
        else:
            if [row["storegco"], row["taue"],row["hs_de"]] in region_foresttype_belt_inprojektionspfade:
                combinations_df.loc[index, "tauehs"] = row['hs_de']

##correct special cases
#for index, row in combinations_df.iterrows():
#    if row ["ta"] in ["3","4"] and row["storegco"]=="R, J, M, 1, 2, 3":
#        combinations_df.loc[index,"tahs"]="untermontan"
#    if row ["ta"] in ["3","4"] and row["storegco"] in ["R 4", "R 5", "R Mendrisiotto"]:
#        combinations_df.loc[index,"tahs"]="unter- & obermontan"
#    if row ["ta"] in ["19L","19LP"] and row["storegco"] in ["R 4", "R 5", "R Mendrisiotto"]:
#        combinations_df.loc[index,"tahs"]="unter- & obermontan"
#    if row ["ta"] in ["19L"] and row["storegco"] =="R, J, M, 1, 2, 3":
#        combinations_df.loc[index,"tahs"]="obermontan"
#    if row ["ta"] in ["25as", "25au"] and row["storeg"] in ["4", "3"]:
#        combinations_df.loc[index,"tahs"]="collin"
#    if row ["ta"] in ["25as", "25au"] and row["storeg"] in ["5", "5a", "5b", "Me"]:
#        combinations_df.loc[index,"tahs"]="collin mit Buche"
#    if row ["ta"] in ["19L", "19LP"] and row["tahs"] =="subalpin" and row["storegco"] =="R, J, M, 1, 2, 3":
#        combinations_df.loc[index,"tahs"]="obermontan"
#    if row ["ta"] in ["19L", "19LP"] and row["tahs"] =="subalpin" and row["storegco"] in ["R 4", "R 5", "R Mendrisiotto"]:
#        combinations_df.loc[index,"tahs"]="unter- & obermontan"
#    if row ["ta"] in ["19LP"] and row["tahs"] =="hochmontan" and row["storegco"] in ["R 4", "R 5", "R Mendrisiotto"]:
#        combinations_df.loc[index,"tahs"]="unter- & obermontan"
#    #if row ["ta"] in ["33m", "42C", "42Q"] and row["tahs"] =="hochmontan" and row["storeg"] in ["4"]:
#    #    combinations_df.loc[index,"tahs"]="collin"
#    #if row ["ta"] in ["33m", "42C", "42Q"] and row["tahs"] =="hochmontan" and row["storeg"] in ["5","5a","5b", "Me"]:
#    #    combinations_df.loc[index,"tahs"]="collin mit Buche"
#    if row ["ta"] in ["59A", "59C", "59E"] and row["tahs"] =="hochmontan" and row["storegco"] =="R, J, M, 1, 2, 3":
...
combinations_df.loc[combinations_df["tauehs"]=="unter-/obermontan", "hszukcor"]="unter- & obermontan"
...
#combinations_df.loc[((combinations_df["tauehs"].isin(["untermontan", "obermontan"]))&(combinations_df["storegco"].isin(["R 4", "R 5", "R Mendrisiotto"]))), "tauehs"]="unter- & obermontan"
...
joblib.dump(combinations_df, projectspace+"/combinations_df"+climatescenario+".sav")
...
for index, row in combinations_df.iterrows():
    ...
    sto_heute1=combinations_df.loc[index, "ta"]
    sto_heute2=combinations_df.loc[index, "taue"]
    hs_heute1=combinations_df.loc[index, "tahs"]
    hs_heute2 = combinations_df.loc[index, "tauehs"]
    ...
    if hs_heute1 in ["obersubalpin", "subalpin","hochmontan"] and hs_zukunft == "collin mit Buche":
        if hs_heute1 in ["obersubalpin", "subalpin"]:
            standortintermhochmontan = concatenate_pathways(sto_heute1, hs_heute1, "hochmontan", tannenareal_heute,tannenareal_zukunft, standortregion, standortregionplain,slope, lage, radiation)
            if [standortregion, standortintermhochmontan, "hochmontan",
                ...
                combinations_df.loc[index, "naiszuk1"] = give_future_foresttype_from_projectionspathways(standortintermhochmontan, "hochmontan", hs_zukunft, tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
        else:
    ...
    if sto_heute2 != '_' and hs_heute2 in ["obersubalpin", "subalpin","hochmontan"] and hs_zukunft == "collin mit Buche":
        if hs_heute2 in ["obersubalpin", "subalpin"]:
            standortintermhochmontan = concatenate_pathways(sto_heute2, hs_heute2, "hochmontan", tannenareal_heute,tannenareal_zukunft, standortregion, standortregionplain,slope, lage, radiation)
            if [standortregion, standortintermhochmontan, "hochmontan",
                hs_zukunft] in pairsofforesttypesandaltitudinalvegetationbelts_inprojektionspfade:
                combinations_df.loc[index, "naiszuk2"] = give_future_foresttype_from_projectionspathways(standortintermhochmontan, "hochmontan", hs_zukunft, tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
        else:
    ...
    if [standortregion,sto_heute1,hs_heute1,hs_zukunft] in pairsofforesttypesandaltitudinalvegetationbelts_inprojektionspfade:
        #if count_changes_altitudinalvegetationbelts(hs_heute, hs_zukunft) == 1:
        combinations_df.loc[index, "naiszuk1"]=give_future_foresttype_from_projectionspathways(sto_heute1, hs_heute1, hs_zukunft, tannenareal_heute,tannenareal_zukunft, standortregion, standortregionplain, slope, lage, radiation)
    else:
        # concatenate pathways
        combinations_df.loc[index, "naiszuk1"]=concatenate_pathways(sto_heute1, hs_heute1, hs_zukunft, tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
    if sto_heute2!='_' and [standortregion,sto_heute2,hs_heute2,hs_zukunft] in pairsofforesttypesandaltitudinalvegetationbelts_inprojektionspfade:
        combinations_df.loc[index, "naiszuk2"] = give_future_foresttype_from_projectionspathways(sto_heute2,hs_heute2,hs_zukunft,tannenareal_heute,tannenareal_zukunft,standortregion,standortregionplain, slope, lage, radiation)
    else:
        if sto_heute2!='_':
            # concatenate pathways
            combinations_df.loc[index, "naiszuk2"] = concatenate_pathways(sto_heute2, hs_heute2, hs_zukunft, tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
    #Region 2b 3
    if standortregionplain in ["2b","3"] and hs_heute1 in ["obersubalpin", "subalpin", "hochmontan"] and hs_zukunft == "collin":
        ...
        if standortregionplain == "2b":
            if [hs_heute1,sto_heute1,hs_zukunft] in extractprojektionswegestoreg2bcombinationslist:
                combinations_df.loc[index, "naiszuk1"] = extractprojektionswegestoreg2b[((extractprojektionswegestoreg2b["Hoehenstufe_heute"]==hs_heute1)&(extractprojektionswegestoreg2b["Standortstyp_heute"]==sto_heute1)&(extractprojektionswegestoreg2b["Hoehenstufe_Zukunft"]==hs_zukunft))]["Standortstyp_Zukunft"].values[0]
            else:
                if hs_heute1 =="obersubalpin":
                    interm1=give_future_foresttype_from_projectionspathways(sto_heute1, "obersubalpin", "subalpin", tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
                    interm2 = give_future_foresttype_from_projectionspathways(interm1, "subalpin", "hochmontan",tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
                    if [hs_heute1, interm2, hs_zukunft] in extractprojektionswegestoreg2bcombinationslist:
                        combinations_df.loc[index, "naiszuk1"] = extractprojektionswegestoreg2b[((extractprojektionswegestoreg2b["Hoehenstufe_heute"] == hs_heute1) & (extractprojektionswegestoreg2b["Standortstyp_heute"] == interm2) & (extractprojektionswegestoreg2b["Hoehenstufe_Zukunft"] == hs_zukunft))]["Standortstyp_Zukunft"].values[0]
                    else:
                        if [standortregion, interm2, "hochmontan",hs_zukunft] in pairsofforesttypesandaltitudinalvegetationbelts_inprojektionspfade:
                            combinations_df.loc[index, "naiszuk1"] = give_future_foresttype_from_projectionspathways(interm2,"hochmontan","collin",tannenareal_heute,tannenareal_zukunft,standortregion,standortregionplain,slope,lage, radiation)
                elif hs_heute1 =="subalpin":
                    interm1=give_future_foresttype_from_projectionspathways(sto_heute1, "subalpin", "hochmontan", tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
            ...
            if [hs_heute1,sto_heute1,hs_zukunft] in extractprojektionswegestoreg3combinationslist:
                combinations_df.loc[index, "naiszuk1"] = extractprojektionswegestoreg3[((extractprojektionswegestoreg3["Hoehenstufe_heute"]==hs_heute1)&(extractprojektionswegestoreg3["Standortstyp_heute"]==sto_heute1)&(extractprojektionswegestoreg3["Hoehenstufe_Zukunft"]==hs_zukunft))]["Standortstyp_Zukunft"].values[0]
            else:
                if hs_heute1 =="obersubalpin":
                    interm1=give_future_foresttype_from_projectionspathways(sto_heute1, "obersubalpin", "subalpin", tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
                    interm2 = give_future_foresttype_from_projectionspathways(interm1, "subalpin", "hochmontan",tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain, slope, lage, radiation)
                    if [hs_heute1, interm2, hs_zukunft] in extractprojektionswegestoreg3combinationslist:
                        combinations_df.loc[index, "naiszuk1"] = extractprojektionswegestoreg3[((extractprojektionswegestoreg3["Hoehenstufe_heute"] == hs_heute1) & (extractprojektionswegestoreg3["Standortstyp_heute"] == interm2) & (extractprojektionswegestoreg3["Hoehenstufe_Zukunft"] == hs_zukunft))]["Standortstyp_Zukunft"].values[0]
                    else:
                        if [standortregion, interm2, "hochmontan",hs_zukunft] in pairsofforesttypesandaltitudinalvegetationbelts_inprojektionspfade:
                            combinations_df.loc[index, "naiszuk1"] = give_future_foresttype_from_projectionspathways(interm2,"hochmontan","collin",tannenareal_heute,tannenareal_zukunft,standortregion,standortregionplain,slope,lage, radiation)
                elif hs_heute1 =="subalpin":
    ...
    if sto_heute2!='_' and standortregionplain in ["2b","3"] and hs_heute2 in ["obersubalpin", "subalpin", "hochmontan"] and hs_zukunft == "collin":
        # check if it is in extract
        if standortregionplain == "2b":
            if [hs_heute2, sto_heute2, hs_zukunft] in extractprojektionswegestoreg2bcombinationslist:
                ...
                if hs_heute2 == "obersubalpin":
                    interm1 = give_future_foresttype_from_projectionspathways(sto_heute2, "obersubalpin", "subalpin",tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain,slope, lage, radiation)
                    interm2 = give_future_foresttype_from_projectionspathways(interm1, "subalpin", "hochmontan",tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain,slope, lage, radiation)
                    if [hs_heute2, interm2, hs_zukunft] in extractprojektionswegestoreg2bcombinationslist:
                        combinations_df.loc[index, "naiszuk2"] = extractprojektionswegestoreg2b[((extractprojektionswegestoreg2b["Hoehenstufe_heute"] == hs_heute2) & (extractprojektionswegestoreg2b["Standortstyp_heute"] == interm2) & (extractprojektionswegestoreg2b["Hoehenstufe_Zukunft"] == hs_zukunft))]["Standortstyp_Zukunft"].values[0]
                    else:
                        if [standortregion, interm2, "hochmontan",
                            hs_zukunft] in pairsofforesttypesandaltitudinalvegetationbelts_inprojektionspfade:
                            combinations_df.loc[
                                index, "naiszuk2"] = give_future_foresttype_from_projectionspathways(interm2,"hochmontan","collin",tannenareal_heute,tannenareal_zukunft,standortregion,standortregionplain,slope, lage, radiation)
                elif hs_heute2 == "subalpin":
                    interm1 = give_future_foresttype_from_projectionspathways(sto_heute2, "subalpin", "hochmontan",tannenareal_heute, tannenareal_zukunft,standortregion, standortregionplain,slope, lage, radiation)
    ...
    if combinations_df.loc[index, "naiszuk1"] in ["nopath","no path c", "", "no path"]:
        combinations_df.loc[index, "naiszuk1"]=correct_nopaths_exemptions(standortregion, standortregionplain, sto_heute1, hs_heute1, hs_zukunft, tannenareal_heute, slope, lage, radiation)
    if combinations_df.loc[index, "ue"]==1 and combinations_df.loc[index, "naiszuk2"] in ["nopath","no path c", "","no path"]:
        combinations_df.loc[index, "naiszuk2"]=correct_nopaths_exemptions(standortregion, standortregionplain, sto_heute2, hs_heute2, hs_zukunft, tannenareal_heute, slope, lage, radiation)
combinations_df.loc[(combinations_df["tahs"]==combinations_df["hszukcor"]), "naiszuk1"]=combinations_df["ta"]
combinations_df.loc[(combinations_df["tauehs"]==combinations_df["hszukcor"]), "naiszuk2"]=combinations_df["taue"]
combinations_df.loc[((combinations_df["tahs"]=="collin") & (combinations_df["hszukcor"]=="collin mit Buche")), "naiszuk1"]=combinations_df["ta"]
combinations_df.loc[((combinations_df["tauehs"]=="collin") &  (combinations_df["taue"]!="")& (combinations_df["hszukcor"]=="collin mit Buche")), "naiszuk2"]=combinations_df["taue"]
#!!!!!!!!correct LI only!!!!!!!!!!!!!
#combinations_df.loc[((combinations_df["taue"]=="24*")&(combinations_df["tauehs"]=="obermontan")&(combinations_df["hszukcor"]=="hochmontan")), "naiszuk2"]="24*"
#combinations_df.loc[((combinations_df["taue"]=="24*")&(combinations_df["tauehs"]=="obermontan")&(combinations_df["hszukcor"]=="hochmontan")), "hszukcor"]="obermontan"
#combinations_df.loc[((combinations_df["taue"]=="48")&(combinations_df["tauehs"]=="untermontan")&(combinations_df["hszukcor"]=="obermontan")), "naiszuk2"]="48"
#combinations_df.loc[((combinations_df["taue"]=="48")&(combinations_df["tauehs"]=="untermontan")&(combinations_df["hszukcor"]=="obermontan")), "hszukcor"]="untermontan"
#combinations_df.loc[((combinations_df["taue"]=="60*")&(combinations_df["tauehs"]=="hochmontan")&(combinations_df["hszukcor"]=="subalpin")), "naiszuk2"]="60*"
#combinations_df.loc[((combinations_df["taue"]=="60*")&(combinations_df["tauehs"]=="hochmontan")&(combinations_df["hszukcor"]=="subalpin")), "hszukcor"]="hochmontan"
#combinations_df.loc[((combinations_df["taue"]=="65")&(combinations_df["tauehs"]=="submontan")&(combinations_df["hszukcor"]=="untermontan")), "naiszuk2"]="65"
#combinations_df.loc[((combinations_df["taue"]=="65")&(combinations_df["tauehs"]=="submontan")&(combinations_df["hszukcor"]=="untermontan")), "hszukcor"]="submontan"
#!!!!!!!!correct SG only!!!!!!!!!!!!!
...
#combinations_df.loc[((combinations_df["taue"]=="9a")&(combinations_df["tauehs"]=="untermontan")&(combinations_df["hszukcor"]=="submontan")), "naiszuk2"]="9a"
#combinations_df.loc[((combinations_df["tauehs"] == "collin")&(combinations_df["hszukcor"].isin(["submontan", "untermontan", "obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]
#combinations_df.loc[((combinations_df["tauehs"] == "collin mit Buche")&(combinations_df["hszukcor"].isin(["submontan", "untermontan", "obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]
#combinations_df.loc[((combinations_df["tauehs"] == "hyperinsubrisch")&(combinations_df["hszukcor"].isin(["submontan", "untermontan", "obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]
#combinations_df.loc[((combinations_df["tauehs"] == "submontan")&(combinations_df["hszukcor"].isin(["untermontan", "obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]
#combinations_df.loc[((combinations_df["tauehs"] == "untermontan")&(combinations_df["hszukcor"].isin(["obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]
#combinations_df.loc[((combinations_df["tauehs"] == "obermontan")&(combinations_df["hszukcor"].isin(["hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]
#combinations_df.loc[((combinations_df["tauehs"] == "unter- & obermontan")&(combinations_df["hszukcor"].isin(["hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]
#combinations_df.loc[((combinations_df["tauehs"] == "hochmontan")&(combinations_df["hszukcor"].isin(["subalpin", "obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]
#combinations_df.loc[((combinations_df["tauehs"] == "subalpin")&(combinations_df["hszukcor"].isin(["obersubalpin"]))), "naiszuk2"]=combinations_df["taue"]

#combinations_df.loc[((combinations_df["taue"]=="46*")&(combinations_df["tauehs"]=="untermontan")&(combinations_df["hszukcor"]=="submontan")), "naiszuk2"]="7*"
#combinations_df.loc[((combinations_df["taue"]=="48G")&(combinations_df["tauehs"]=="obermontan")&(combinations_df["hszukcor"]=="untermontan")), "naiszuk2"]="22"
#combinations_df.loc[((combinations_df["taue"]=="53Ta")&(combinations_df["tauehs"]=="untermontan")&(combinations_df["hszukcor"]=="submontan")), "naiszuk2"]="62"
#combinations_df.loc[((combinations_df["taue"]=="26h")&(combinations_df["tauehs"]=="untermontan")&(combinations_df["hszukcor"]=="submontan")), "naiszuk2"]="26"
#combinations_df.loc[((combinations_df["taue"]=="48G")&(combinations_df["tauehs"]=="obermontan")&(combinations_df["hszukcor"]=="submontan")), "naiszuk2"]="22"
...
for index, row in nopaths[["storegco","ta","tahs","hszukcor"]].iterrows():
    if [row["storegco"],row["ta"], row["tahs"], row["hszukcor"]] not in listofnopathcombinations:
        listofnopathcombinations.append([row["storegco"],row["ta"], row["tahs"], row["hszukcor"]])
...
for index, row in nopaths2[["storegco","taue","tauehs","hszukcor"]].iterrows():
    if row["taue"]!= "" and [row["storegco"],row["taue"], row["tauehs"], row["hszukcor"]] not in listofnopathcombinations2:
        listofnopathcombinations2.append([row["storegco"],row["taue"], row["tauehs"], row["hszukcor"]])
len(listofnopathcombinations2)
listofnopathcombinations2.sort()
#listofnopathcombinations
nopathoutfile=open(projectspace+"/"+climatescenario.lower()+"_listofnopathcombinations.txt", "w")
...
for item in listofnopathcombinations2:
    nopathoutfile.write(str(item[0])+";"+str(item[1])+";"+str(item[2])+";"+str(item[3])+"\n")
nopathoutfile.close()
joblib.dump(combinations_df, projectspace+"/"+climatescenario+"_combinations_df_futureSTO.sav")
...
joblib.dump(combinations_df_baumartenempfehlung, projectspace+"/sg_"+climatescenario.lower()+"_baumartenempfehlungen.sav")
...
combinations_df_senstivestandorte.to_file(projectspace+"/"+"sg_"+climatescenario+"_sensitivestandorte.shp")
...
combinations_df.columns
combinations_df.to_file(projectspace+"/"+"sg_"+climatescenario+"_zukuenftigestandorte.shp")
...
combinations_df=joblib.load(projectspace+"/"+climatescenario.lower()+"_combinations_df_futureSTO.sav")
#combinations_df_bedeutung.to_file(projectspace+"/"+"sg_"+climatescenario+"_baumartenbedeutungen.shp") #berechnung dauert lange!
#combinations_df_bedeutung.to_file(projectspace+"/"+"sg_"+climatescenario+"_baumartenbedeutungen.gpkg", layer="sg_"+climatescenario+"_baumartenbedeutungen", driver="GPKG")
combinations_df_baumartenempfehlung.columns
combinations_df_baumartenempfehlung.to_file(projectspace+"/"+"sg_"+climatescenario+"_baumartenempfehlungen.shp")
