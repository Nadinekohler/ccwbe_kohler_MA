...
# Wichtig!
# Bevor dieses Skript gerechnet werden kann, muss die Modellierung "ccwbe_standorthinweiskarteV2_rcp45" und die Schritte in der ArcMap Toolbox "postprocessing2_rcp45" durchgerechnet worden sein.
